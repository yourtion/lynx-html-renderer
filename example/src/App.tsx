...
<div style="padding: 20px; max-width: 800px; margin: 0 auto; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif;">
  <header style="background-color: #f8f9fa; padding: 10px; border-radius: 8px; margin-bottom: 10px; text-align: center;">
  ...
  <section style="margin-bottom: 5px;">
    <h2 style="font-size: 24px; color: #333; margin-bottom: 3px; border-bottom: 2px solid #e9ecef; padding-bottom: 10px;">✨ 项目简介 | Introduction</h2>
  ...
  <section style="margin-bottom: 5px;">
    <h2 style="font-size: 24px; color: #333; margin-bottom: 3px; border-bottom: 2px solid #e9ecef; padding-bottom: 10px;">🎯 设计目标 | Design Goals</h2>
    <div style="display: flex; flex-wrap: wrap; gap: 15px; margin-bottom: 3px;">
  ...
  <section style="margin-bottom: 5px;">
    <h2 style="font-size: 24px; color: #333; margin-bottom: 3px; border-bottom: 2px solid #e9ecef; padding-bottom: 10px;">🖼️ 渲染示例 | Rendering Examples</h2>
    
    <h3 style="font-size: 18px; color: #495057; margin-bottom: 15px;">1. 文本格式化</h3>
    <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 3px;">
    ...
    <div style="display: flex; gap: 15px; margin-bottom: 3px; flex-wrap: wrap;">
    ...
    <div style="background-color: #e3f2fd; padding: 20px; border-radius: 8px; margin-bottom: 3px;">
  ...
  <section style="margin-bottom: 5px;">
    <h2 style="font-size: 24px; color: #333; margin-bottom: 3px; border-bottom: 2px solid #e9ecef; padding-bottom: 10px;">📦 功能特性 | Features</h2>
